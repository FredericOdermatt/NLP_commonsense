...
do
    bsub -o checkpoint${i}.out -R "rusage[ngpus_excl_p=1,mem=12000]" -J checkpoint${i} -W 4:00 ./generate_with_evidence.sh checkpoint-${i} ${BASE_FOLDER}/checkpoint-${i} 50 1 0.9
